      ...
      <div className="max-w-[1152px] mx-auto flex gap-7">
        ...
        <div className="w-[75%]">
          ...
          <div className="section" ref={replacesRef}>
            ...
            <div className={`p-4 shadow-[0_0px_13px_-3px_rgba(0,0,0,0.5)] rounded-lg mt-2 flex gap-[15px] items-start ${activeReplaces?" border-2":''}` }>
          ...
          <div className="section mt-12 relative" ref={descRef}>
            ...
            <div className={`p-4 shadow-[0_0px_13px_-3px_rgba(0,0,0,0.5)] rounded-lg mt-2 flex gap-[15px] items-start ${activeDesc?" border-2":''}`}>
              <ReactTextareaAutosize
